...
public class FiringTower : TargetingTower
{
    ...
    //Methods:
    private void AimAtTarget()//Rotates the tower's barrel towards the target enemy
    {
    ...
    private void GetNextTarget()//Sets the targeted enemy to the closest enemy within range
    {
